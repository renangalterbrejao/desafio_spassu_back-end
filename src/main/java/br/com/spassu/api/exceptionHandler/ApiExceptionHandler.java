package br.com.spassu.api.exceptionHandler;
...
import br.com.spassu.core.validation.ValidacaoException;
import br.com.spassu.domain.exception.EntidadeEmUsoException;
import br.com.spassu.domain.exception.EntidadeNaoEncontradaException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	private ResponseEntity<Object> handlePropertyBindingException(PropertyBindingException ex, HttpHeaders headers,
		...
		// detail = String.format("A propriedade '%s' foi ignorada. "
		// + "Por favor, insira esta propriedade na requisição e tente novamente.",
		// path);
		// }
